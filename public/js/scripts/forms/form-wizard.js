...
$(function () {
  ...
  //         formdata.append("client_type", jQuery('div#account-details input[type="radio"]:checked').val());
  //         jQuery('div#personal-info input').each(function(){
  //           if(jQuery(this).val() != '' && jQuery(this).val().length >= 1)
  //           {
  //             formdata.append(jQuery(this).attr('name'),jQuery(this).val());
  //           }
  //         });
  //         formdata.append('opanning_balance_type',jQuery('div#balance-info input[type="radio"]:checked').val());
  //         formdata.append('opanning_balance',jQuery('div#balance-info input#opaning_balance').val());
  //         jQuery.ajax({
  //           type: 'POST',
