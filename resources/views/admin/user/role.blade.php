...
{{-- <form id="add_master_item" class="row w-100 pr-lg-0 pr-1 py-2" action="/master/add/" mathod="POST">
  <div class="add_section_item col-lg-8 col-8 my-lg-0 my-2">
    <input type="text" class="form-control" name="add_section_item_name" value="" id="add_section_item_name">
  </div>
  <div class="add_section_item col-lg-4 col-4 my-lg-0 my-2">
    <input type="submit" name="add_section_item_btn" value="Add Master Item"
      class="btn btn-primary btn-sm btn-add-new waves-effect waves-float waves-light" id="add_section_item_btn">
    </div>
  </div>
</form> --}}
...
<div class="col-md-3 d-flex product-details-border position-relative pr-0">
    <div class="row w-100 pr-lg-0 pr-1 py-2" style="padding: 0 !important;">
      <div class="col-lg-12 col-12"
        ...
        <input type="text" name="role[]" class="form-control master_value_item" data-role-id="" value="" placeholder="Enter Role" />
      </div>
    </div>
    <div
      class="d-flex flex-column align-items-center justify-content-between border-left invoice-product-actions py-50 px-25"
      style="width: 20%;">
      <i data-feather="x" class="cursor-pointer font-medium-3 repeater-delete"></i>
    </div>
  </div>
...
?>
                  <div class="col-md-3 d-flex product-details-border position-relative pr-0">
                    <div class="row w-100 pr-lg-0 pr-1 py-2" style="padding: 0 !important;">
                      <div class="col-lg-12 col-12"
                        style="padding: 0 !important;padding-right: 13px !important;">
                        <input type="text" name="role[]" class="form-control master_value_item" data-role-id="<?=$id?>" value="<?=$role?>" placeholder="<?=$role?>" />
                      </div>
                    </div>
                    <div
                      class="d-flex flex-column align-items-center justify-content-between border-left invoice-product-actions py-50 px-25"
...
<script>
  ...
  jQuery("button.btn.btn-primary.btn-save-item").click(function (e) {
    ...
    formdata.append("role_list",master_value_item);
...
<script>
  jQuery('li.nav-item.role').addClass('active');
  </script>
@endsection
