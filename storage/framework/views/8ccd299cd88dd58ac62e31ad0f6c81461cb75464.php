...
<div
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('UserRead')): ?>
      <li class="nav-item">
        ...
        <ul class="menu-content">
          ...
          <?php endif; ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('RoleRead')): ?>
          ...
          <?php endif; ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('PermissionRead')): ?>
...
<!-- END: Main Menu--><?php /**PATH C:\xampp\htdocs\public_html\resources\views/panels/sidebar.blade.php ENDPATH**/ ?>