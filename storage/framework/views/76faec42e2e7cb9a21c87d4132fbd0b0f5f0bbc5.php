...
console.log('status',"<?php echo e(session('status')); ?>");
console.log('massege',"<?php echo e(session('massege')); ?>");

<?php if(session('status') == 'true' || session('status') == true || session('status') == 1 || session('status') == "1"): ?>
    <?php if(session('massege')): ?>
        
        Swal.fire({
            position: 'bottom-end',
            icon: 'info',
            title: "<?php echo e(session('massege')); ?>",
...
<?php if(session('status') == 'false' || session('status') == false || session('status') == 0 || session('status') == "0"): ?>
    <?php if(session('massege')): ?>
        Swal.fire({
            title: '',
            html: "<?php echo e(session('massege')); ?>",
            icon: 'info',
            timer: 3000,
            customClass: {
            confirmButton: 'btn btn-primary'
...
<?php /**PATH C:\xampp\htdocs\public_html\resources\views/panels/scripts.blade.php ENDPATH**/ ?>